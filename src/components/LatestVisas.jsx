    ...
    <section className="py-10 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
        ...
        {loadedVisas.map((visa) => (
          <div
            key={visa._id}
            className="p-6 rounded-3xl bg-gray-100 dark:bg-gray-700 shadow-[8px_8px_16px_rgba(0,0,0,0.2),-8px_-8px_16px_rgba(255,255,255,0.1)] hover:shadow-[10px_10px_20px_rgba(0,0,0,0.3),-10px_-10px_20px_rgba(255,255,255,0.2)] transition-all transform hover:scale-105"
          >
            <img
              src={visa.countryImage}
              alt={visa.countryName}
              className="rounded-lg w-full h-40 object-cover mb-4 shadow-[4px_4px_8px_rgba(0,0,0,0.2),-4px_-4px_8px_rgba(255,255,255,0.1)]"
            />
